...
var require_follow_redirects = __commonJS({
  "node_modules/follow-redirects/index.js"(exports2, module2) {
    ...
    function createErrorType(code, defaultMessage2) {
      function CustomError(message2) {
        Error.captureStackTrace(this, this.constructor);
        this.message = message2 || defaultMessage2;
      }
...
// src/functions/list-films/handler.ts
__export(exports, {
  main: () => main
});
...
// src/repositories/swapi-film.repository.ts
var import_axios = __toModule(require_axios2());
var SwapiFilmRepository = class {
  async getAllFilms() {
    const films = await import_axios.default.get(process.env.BASE_URL_SWAPI + "api/films/");
    return films;
  }
  async getFilm(id) {
    const films = await import_axios.default.get(process.env.BASE_URL_SWAPI + "api/films/" + id);
    return films;
  }
  async getFilmSchema() {
    const films = await import_axios.default.get(process.env.BASE_URL_SWAPI + "api/films/schema/");
    return films;
  }
};
...
var handler = async () => {
  ...
  const films = await swapiRepository.getAllFilms();
  if (!films && !films.data) {
    return {
      statusCode: 200,
      body: JSON.stringify({
